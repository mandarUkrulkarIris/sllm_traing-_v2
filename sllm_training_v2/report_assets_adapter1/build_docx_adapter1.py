...
MD_PATH = sys.argv[1] if len(sys.argv) > 1 else os.path.join(BASE_DIR, "report_assets_adapter1", "dataset_report_adapter1.md")
OUT_PATH = sys.argv[2] if len(sys.argv) > 2 else os.path.join(BASE_DIR, "Dataset and Training report_adapter1.docx")
