...
# Qwen3.5-9B via QLoRA (4-bit NF4 base + LoRA adapters) — the 9B base
# roughly doubles the memory footprint of the 4B model used in main_v2.py,
# so the base weights are quantized to keep this trainable on the same GPU class.
# ==========================================
MODEL_ID = "Qwen/Qwen3.5-9B"
DATASET_PATH = "/teamspace/uploads/dataset_v16v2_200726.clean.canonical.jsonl"
OUTPUT_MODEL_DIR = "./teamspace/uploads/Qwen3.5-9B_v16v2_clean_dataset_210726_v3"
...
# ==========================================
# 3. LOAD MODEL TO GPU (4-bit NF4 quantized base)
# ==========================================
print(f"Loading {MODEL_ID} to GPU (4-bit NF4, bf16 compute)...")
...
# ==========================================
# 5. TRAINING ARGS
# Per-device batch size is dropped to 1 (vs. 2 in main_v2.py) and gradient
# accumulation raised to 48 (vs. 24) to hold the same effective batch size
# of 48 while fitting the larger 9B QLoRA model in memory.
# ==========================================
EFFECTIVE_BATCH = 1 * 48
...
print("quantization_config.json saved")
