...
# Raw/cleaned datasets live alongside this script (dataprep/); the report is
# kept at the repo root next to the other dataset/training reports.
DEFAULT_INPUT_PATH = os.path.join(SCRIPT_DIR, "dataset_v16v2_200726.jsonl")
DEFAULT_OUTPUT_PATH = os.path.join(SCRIPT_DIR, "dataset_v16v2_200726.clean.jsonl")
DEFAULT_REPORT_PATH = os.path.join(ROOT_DIR, "dataset_clean_report.txt")

parser = argparse.ArgumentParser(description=__doc__)
parser.add_argument("--input", default=DEFAULT_INPUT_PATH, help="Raw compiled dataset (.jsonl)")
parser.add_argument("--output", default=DEFAULT_OUTPUT_PATH, help="Where to write the cleaned dataset (.jsonl)")
parser.add_argument("--report", default=DEFAULT_REPORT_PATH, help="Where to write the cleaning report (.txt)")
