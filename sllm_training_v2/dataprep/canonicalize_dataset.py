...
# Cleaned/canonical datasets live alongside this script (dataprep/); the
# report is kept in report_assets/ next to the other pipeline reports.
DEFAULT_INPUT_PATH = os.path.join(SCRIPT_DIR, "dataset_v16v2_200726.clean.jsonl")
DEFAULT_OUTPUT_PATH = os.path.join(SCRIPT_DIR, "dataset_v16v2_200726.clean.canonical.jsonl")
DEFAULT_REPORT_PATH = os.path.join(ROOT_DIR, "report_assets", "canonicalization_report.json")

parser = argparse.ArgumentParser(description=__doc__)
parser.add_argument("--input", default=DEFAULT_INPUT_PATH, help="Cleaned dataset (.jsonl)")
parser.add_argument("--output", default=DEFAULT_OUTPUT_PATH, help="Where to write the canonicalized dataset (.jsonl)")
parser.add_argument("--report", default=DEFAULT_REPORT_PATH, help="Where to write the canonicalization report (.json)")
