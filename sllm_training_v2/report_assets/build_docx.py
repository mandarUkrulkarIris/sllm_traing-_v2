...
BASE_DIR = r"D:\Dev\sllm_training_v2"
MD_PATH = sys.argv[1] if len(sys.argv) > 1 else r"D:\Dev\sllm_training_v2\dataset_report.md"
OUT_PATH = sys.argv[2] if len(sys.argv) > 2 else r"D:\Dev\sllm_training_v2\Dataset_and_Training_Report.docx"
